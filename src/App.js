    ...
    render() {
        return (
            ...
            <div className="App">
                ...
                <button onClick={this.switchNameHandler}>Change Data</button>
                <Person name={this.state.persons[0].name} age={this.state.persons[0].age}/>
                <Person name={this.state.persons[1].name} age={this.state.persons[1].age}>My hobby is eat a lot</Person>
